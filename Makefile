...
C_SRCS      := kernel/main.c drivers/serial.c drivers/mouse.c arch/x86/gdt.c arch/x86/idt.c arch/x86/exception.c arch/x86/pic.c arch/x86/irq_handler.c mm/multiboot.c mm/pmm.c arch/x86/paging.c mm/kheap.c sched/task.c arch/x86/tss.c arch/x86/syscall_dispatch.c fs/vfs.c fs/ramfs.c fs/elf.c gfx/primitives.c gfx/font.c
